...
![お題一覧](./docs/images/theme-list.png)

登録されているお題をカードで一覧表示します。各カードには、数直線の両端（小さい方・大きい方）に対応する言葉が設定されています。

### シャッフル

![シャッフル](./docs/images/shuffle.png)

**[シャッフル]** ボタンを押すと、全お題からランダムに3つを選んで先頭に表示します。ゲームを始めるときのお題選びに使えます。

### ページ送り

![ページ送り](./docs/images/pagination.png)

お題はページごとに表示されます。現在ページの前後と、最初・最後のページだけを表示し、間は「…」で省略します。スマホの画面幅でも折り返して収まります。

### お題詳細（数直線）

![お題詳細](./docs/images/theme-detail.png)
